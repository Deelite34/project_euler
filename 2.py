...
class Fibonacci(unittest.TestCase):
    ...
    def calculations(self, number):  # Using recursive method to calculate specific fib number
        if number == 0:
            return(1)
        elif number < 2:
            return(1)
            ...
            if recursive_sum < 4000000:
                ...
                return(False)  # False lets parent function(calculate_fib) know to not continue the loop
